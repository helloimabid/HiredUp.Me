...
const JOB_GENERATOR_SERVICE_URL = process.env.JOB_GENERATOR_SERVICE_URL || 'https://job-generator-service.onrender.com';
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to connect to job generation service', details: error.message },
      { status: 500 }
    );
  }
}
